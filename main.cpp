...
void insertionMethod(BPTree** bPTree) {
    ...
    string userTuple =
        name + " " + to_string(age) + " " + to_string(marks) + "\n";
...
int main() {
    system("chcp 65001");  // Change console coding-type to utf-8

    /*
           Please have a look at the default schema to get to know about the
       table Reference - img/database.jpg
       */
    ...
    cout << "Please provide the value to limit maximum child Internal Nodes "
            "can have: ";
    cin >> maxChildInt;
    cout << "\nAnd Now Limit the value to limit maximum Nodes Leaf Nodes can "
            "have: ";
    cin >> maxNodeLeaf;
